    ...
    @section('content')
        ...
        <form  action="{{ route('products.store') }}" Method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="name" aria-describedby="namehelp" value = "">
            ...
            <div class="mb-3">
                ...
                <input name="price" type="number" class="form-control" id="price" value = "">
            </div>
            <div class="mb-3" >
                <label for="image" class="form-label"> 
                    <strong>Image</strong> 
                </label>
                <img id ="image" src="" class="rounded-circle" alt="example placeholder" style="width: 200px;">
